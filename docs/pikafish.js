var fs = (typeof require!=='undefined') ? require('fs') : { readFile: function(p,cb){ fetch(p).then(function(r){ if(!r.ok) throw new Error('HTTP '+r.status+' '+p); return r.arrayBuffer(); }).then(function(ab){ cb(null, new Uint8Array(ab)); }).catch(function(e){ cb(e); }); } };
...
if (typeof module!=='undefined') module.exports=Pikafish; if (typeof self!=='undefined') self.Pikafish=Pikafish; if (typeof globalThis!=='undefined') globalThis.Pikafish=Pikafish;
